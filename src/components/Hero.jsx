  ...
  return (
    <div className="pt-24 bg-black text-white md:pt-32">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16 relative">
        {/* Subtitle */}
        <div>
          <span className="text-[#999999] uppercase tracking-[0.2em] text-sm">
        ...
        <div className="flex md:flex-row items-center flex-col justify-between gap-8">
          <p className="text-[#999999] md:w-4/5 md:text-xl mb-8 md:mb-0 leading-relaxed">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Beatae
            labore ex odit voluptates voluptatibus a corporis dolorem iure et
            harum culpa aperiam nemo officia quibusdam, amet doloremque nihil
            aliquam praesentium!
          </p>
          ...
          <div className="flex sm:flex-row flex-wrap gap-8 shrink-0">
            <Link
              to="/"
              className="bg-[#4353FF] hover:bg-blue-700 text-white font-medium py-4 px-8 rounded text-lg transition-colors duration-200"
            >
              Start Building
            </Link>
            <Link
              to="/"
              className=" hover:bg-gray-800 text-white hover:text-white/40 group flex items-center font-normal py-4 px-8 rounded text-lg transition-colors duration-200"
            >
              Contact sales{" "}
        ...
        {/* Overlay */}
        <div className="absolute bottom-0 left-0 right-0 z-10 h-1/2 bg-gradient-to-t from-black to-transparent hidden md:block"></div>
      </div>
    </div>
  );
};
